                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="review_form.jsp">
                            <img src="/pro01/images/gookbap7.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            ...
                            <a href="review_form.jsp" class="h2 text-decoration-none text-dark">치즈케익 끝판왕!!</a>
                            <p class="card-text">
                                서울시 서초구 서초대로58길 37
                            </p>
                            <p class="text-muted">리뷰 갯수 (24)</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="review_form.jsp">
                            <img src="/pro01/images/gookbap12.png" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
                            ...
                            <a href="review_form.jsp" class="h2 text-decoration-none text-dark">짜장면 시키신 분?</a>
                            <p class="card-text">
                                서울특별시 강남구 삼성1동 156-5
                            </p>
                            <p class="text-muted">리뷰 갯수 (48)</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="review_form.jsp">
                            <img src="/pro01/images/taco2.png" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
                            ...
                            <a href="review_form.jsp" class="h2 text-decoration-none text-dark">타코의 파라다이스.</a>
                            <p class="card-text">
                                서울특별시 강남구 봉은사로78길 12 101호
                            </p>
                            <p class="text-muted">리뷰 갯수 (13)</p>
                        </div>
                    </div>
                </div>
            </div>
